...
from apollo_v7_testing.grading_metrics import collision, acceleration, speeding

RECORD_DIR = '/apollo/apollo_v7_testing/results/recorded_scenarios/'
CSV_PATH = '/apollo/apollo_v7_testing/oracles/file_names.txt'
