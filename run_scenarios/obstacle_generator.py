...
def obs_files_generator(obs_deme, scenario_counter):
    ...
    for obs_indi in obs_deme:
        ...
        obs_indi[4],obs_indi[5],obs_indi[6],obs_indi[7]=check_obs_type(obs_indi[4],obs_indi[5],obs_indi[6],obs_indi[7],obs_indi[8])
        desc=generateObsDescFile(obs_indi[0],obs_indi[3],obs_indi[4],obs_indi[5],obs_indi[6],obs_indi[7],obstacle_type[obs_indi[8]])
