import os
import shutil
from config import PROJECT_ROOT, APOLLO_RECORDS_DIR, OBS_DIR
...
def runOracles(scenario_player_output, record_name, scenario, adc_route):
    ...
    if collision == None:
        ...
        for obs in scenario:
            if obs[0] == obs_id:
                ...
                obs_wid = obs[5]
                obs_height = obs[6]
    temp = "{},{},{},{},{},{},{},{},{},{},{},{},{}".format(record_name, c_x, c_y, c_type, adc_heading, adc_speed,
                                                           obs_id, obs_heading, obs_speed, obs_type, obs_len, obs_wid,
                                                           obs_height)
    result = temp
    ...
    temp = ",{},{},{},{},{},{}".format(speeding_x, speeding_y, speeding_value, speeding_duration, speeding_heading,
                                       str(speed_limit).replace(', ', '|'))
    result += temp
    ...
    viol = ",{},{},{},{},{},{}\n".format(c_counter, speeding_counter, uslc_counter, fastAccl_counter, hardBrake_counter,
                                         total_vio)
    result += viol
