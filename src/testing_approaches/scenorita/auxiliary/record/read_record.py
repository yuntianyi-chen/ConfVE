...
# from testing_approaches.scenorita.auxiliary.record.message_types import type_to_class
...
def read_by_channel(record_name, record_dir, channels=DEFAULT_CHANNELS, verbose=False):
    ...
    for channel_name, msg, timestamp in record.read_messages():
        ...
        if channel_name in channels:
            try:
                ...
                parsed_msg = msg
                messages.append(
                    (channel_name, parsed_msg, timestamp))
