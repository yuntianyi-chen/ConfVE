...
if __name__ == "__main__":
    ...
    desc = generateObsDescFile(random.randint(0, 30000), random.uniform(-3.14, 3.14), random.randint(1, 7),
                               random.randint(1, 10), random.randint(1, 30), random.randint(1, 55))
    path = nx.shortest_path(diGraph, source=lane1, target=lane2)
