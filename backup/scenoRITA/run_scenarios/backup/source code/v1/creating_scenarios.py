...
def runScenario(deme,record_name):
    ...
    while failed:
        ...
        # record_name=str(scenario_counter)
        # ------- running the scneario -------
        scenario_player_cmd='bazel run //apollo_v7_testing/scenario_player:run_automation -- -rv '+adc_routing+' -o '+record_name
